...
class GuestEventInfoView extends StatefulWidget {
  const GuestEventInfoView({
    required this.event,
  ...
  @override
  State<GuestEventInfoView> createState() => _GuestEventInfoViewState();
}

class _GuestEventInfoViewState extends State<GuestEventInfoView> {
  Timer? _timer;
  ...
  Widget build(BuildContext context) {
    ...
    var artworkUrl = _buildCoverImageUrl(widget.event.coverImage);
    if ((artworkUrl == null || artworkUrl.isEmpty) &&
        widget.tracks.isNotEmpty) {
      artworkUrl = widget.tracks.first.thumbnailUrl;
    }
